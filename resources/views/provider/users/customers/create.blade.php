...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/users/customer')}}">العملاء</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <form role="form" action="{{url('/admin/add/user/customer')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" placeholder="اسم  المستخدم" class="form-control" value="{{old('name')}}" />
                                                @if ($errors->has('name'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="full_name" placeholder="الأسم  بالكامل" class="form-control" value="{{old('full_name')}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="national_id" placeholder="رقم  الهوية" class="form-control" value="{{old('national_id')}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="job_id" placeholder="الرقم  الوظيفي" class="form-control" value="{{old('job_id')}}" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sector" placeholder="القطاع" class="form-control" value="{{old('sector')}}" />
