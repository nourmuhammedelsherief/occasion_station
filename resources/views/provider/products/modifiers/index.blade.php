                ...
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{route('createProviderProductModifier' , $product->id)}}">
                        ...
                        @foreach($modifiers as $modifier)
                            @if($modifier->parent_id == null)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{route('editProviderProductModifier' , $modifier->id)}}">
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.delete_country', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/provider/provider_product_modifiers/delete/" + id;
                });
            });
        });
    </script>
