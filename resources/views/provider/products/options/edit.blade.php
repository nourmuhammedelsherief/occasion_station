...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/provider/product_options/' . $option->product->id)}}">@lang('messages.product_options')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('updateProviderProductOption' , $option->id)}}" enctype="multipart/form-data" >
