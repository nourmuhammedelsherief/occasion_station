...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/provider/provider_product_options' , $product->id)}}">@lang('messages.product_options')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{route('createProviderProductOption' , $product->id)}}">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{route('ProviderProductModifier' , $product->id)}}">
                                        <button id="sample_editable_1_new"
                        ...
                        @foreach($options as $option)
                            @if($option->parent_id == null)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{route('editProviderProductOption' , $option->id)}}">
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.delete_country', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/provider/provider_product_options/delete/" + id;
                });
            });
        });
    </script>
