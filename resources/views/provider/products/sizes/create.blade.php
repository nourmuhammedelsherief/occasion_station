...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/provider_product_sizes/' . $product->id)}}">@lang('messages.product_sizes')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>اضافه  @lang('messages.product_sizes')</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">اضافه  @lang('messages.product_sizes') ({{app()->getLocale() == 'ar' ? $product->name : $product->name_en}})
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('storeProviderProductSize' , $product->id)}}" enctype="multipart/form-data" >
                <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-anchor font-green-sharp"></i>
                            <span class="caption-subject font-green-sharp bold uppercase"> أضافه @lang('messages.product_sizes')</span>
                        </div>
