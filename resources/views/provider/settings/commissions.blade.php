                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalScrollableTitle">صورة التحويل البنكي للعميل لدفع العمولة</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <img src="{{asset('/uploads/transfer_photos/'.$commission->commission_photo)}}"
                                                             width="500px"/>
                                                    </div>
