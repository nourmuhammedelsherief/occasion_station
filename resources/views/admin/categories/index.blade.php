...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/categories')}}">الأقسام الرئيسية</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                        ...
                        @foreach($categories as $category)
                            @if($category->parent_id == null)
                                <tr class="odd gradeX">
                                    ...
                                    <td> {{$category->name}} </td>
                                    <td>
                                        <a href="{{route('arrangeCategory' , $category->id)}}"
                                    ...
                                    <td>
                                        {{\App\Models\ProviderMainCategory::whereCategoryId($category->id)->count()}}
                                    </td>
                                    <td>
                                        <div class="btn-group">
