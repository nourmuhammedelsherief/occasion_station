                ...
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{route('createProviderRates' , $provider->id)}}">
                                        <button id="sample_editable_1_new"
                                                class="btn sbold green"> أضافه
                                            تقييم
                        ...
                        @foreach($rates as $rate)
                            @if($rate->parent_id == null)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="tel:{{$rate->user->phone_number}}"> {{$rate->user->phone_number}} </a>
                                    </td>
                                    <td> {{$rate->rate}} </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{route('editProviderRates' , $rate->id)}}">
                                                        <i class="icon-docs"></i> تعديل </a>
                                                </li>
                                                <li>
                                                    <a class="delete_country" data="{{$rate->id}}"
                                                       data_name="{{$rate->user->name}}">
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.delete_country', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/providers/rates/delete/" + id;
                });
            });
        });
    </script>
