...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('storeProviderRates' , $provider->id)}}" enctype="multipart/form-data" >
                <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-anchor font-green-sharp"></i>
                            <span class="caption-subject font-green-sharp bold uppercase"> أضافه تقييمات المزود</span>
                        </div>
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="rate_text" class="form-control" rows="5" cols="5"></textarea>
                                                    @if ($errors->has('rate'))
                                                        <span class="help-block">
                                                            <strong style="color: red;">{{ $errors->first('rate') }}</strong>
                                                        </span>
