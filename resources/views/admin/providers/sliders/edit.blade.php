...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('providerSlider' , $slider->provider->id)}}">السلايدر المتحرك</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('updateproviderSlider' , $slider->id)}}" enctype="multipart/form-data" >
                <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-anchor font-green-sharp"></i>
                            <span class="caption-subject font-green-sharp bold uppercase"> تعديل السلايدر المتحرك</span>
                        </div>
