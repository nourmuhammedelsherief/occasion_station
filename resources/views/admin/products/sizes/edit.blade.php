...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('/admin/product_sizes/' . $size->product->id)}}">@lang('messages.product_sizes')</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="{{route('updateProductSize' , $size->id)}}" enctype="multipart/form-data" >
