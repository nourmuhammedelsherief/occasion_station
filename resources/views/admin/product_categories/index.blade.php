...
@section('page_header')
    ...
    <h1 class="page-title">عرض  أقسام المزودين
        <small>عرض  أقسام المزودين</small>
    </h1>
@endsection
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{route('createProductCategory')}}">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{route('editProductCategory' , $category->id)}}">
                                                        <i class="icon-docs"></i> تعديل </a>
                                                </li>
                                                <li>
                                                    <a class="delete_country" data="{{$category->id}}"
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.delete_country', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/product_categories/delete/" + id;
                });
            });
        });
    </script>
