...
{{--                                            </div>--}}
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title" class="form-control" placeholder="أكتب عنوان الاشعار " value="{{old('title')}}">
                                                    @if ($errors->has('title'))
                                                        <span class="help-block">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea  name="message" class="form-control" placeholder="أكتب  محتوي  الاشعار " ></textarea>
