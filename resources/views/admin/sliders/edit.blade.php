                ...
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase"> تعديل السلايدر الأعلاني</span>
                        </div>
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="title" class="form-control" placeholder="أكتب عنوان السلايدر الأعلاني" value="{{$slider->title}}" required>
                                                    @if ($errors->has('title'))
                                                ...
                                                <div class="col-md-9">
                                                    <select name="provider_id" class="form-control">
                                                        ...
                                                        @foreach($providers as $provider)
                                                            <option value="{{$provider->id}}" {{$slider->provider_id == $provider->id ? 'selected' : ''}}> {{$provider->name}} </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-9">
                                                    <select name="product_id" class="form-control">
                                                        ...
                                                        @foreach($products as $product)
                                                            <option value="{{$product->id}}" {{$slider->product_id == $product->id ? 'selected' : ''}}> {{$product->name}} </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="url" name="outer_url" class="form-control" placeholder="أدخل رابط خارجي للسلايدر في حاله ليس هناك  مزود أو  منتج" value="{{$slider->outer_url}}" required>
