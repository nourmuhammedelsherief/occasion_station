                ...
                <div class="portlet light bordered table-responsive">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green-sharp bold uppercase"> أضافه المدن</span>
                        </div>
...
{{--                                                <div class="col-md-9">--}}
{{--                                                    <input type="text" name="code" class="form-control" placeholder=" أكتب كود المدينة" value="{{old('code')}}" required>--}}
{{--                                                    @if ($errors->has('code'))--}}
{{--                                                        <span class="help-block">--}}
