<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="">
                <img src="{{ URL::asset('/images/occation_station.jpeg') }}" style="width: 104px; height: 50px" alt="logo" class="logo-default" /> </a>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                @if(auth()->guard('admin')->user()->admin_category_id == 4 || auth()->guard('admin')->user()->admin_category_id == 5)
                    <li id="result" class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            @if(auth()->guard('admin')->user()->unReadNotifications->count() > 0)
                                <li><a href="{{url('/markAdminNotifyAsRead')}}" style="color: #0b4d3f"> تحديد الكل كمقروء </a></li>
                            @else
                                <li><a href="#" style="color: #0b4d3f"> لا يوجد أشعارات جديدة </a></li>
                            @endif
                            @foreach(auth()->guard('admin')->user()->unReadNotifications as $notification)
                                <li style="background-color: lightgray">
                                    <a href="{{route('showOrder' , [$notification->data['order_id'] , $notification->id])}}">  طلب جديد رقم {{$notification->data['order_id']}} </a>
                                </li>
                            @endforeach
...
{{--<script>--}}
{{--    $( "#result" ).load( "admin.layouts.header", function() {--}}
{{--    });--}}
