...
//            'password_confirm' => 'required_with:password|same:password|min:4',
    ...
    public function create()
    {
        ...
        return view('admin.admins.admins.create' , compact('categories'));
    }
    ...
    public function edit($id)
    {
        $categories = AdminCategory::all();
        $data = Admin::find($id);
        return view('admin.admins.admins.edit', compact('data' , 'categories'));
    }
...
//        dd($request->role);
        $this->validate($request, [
            'name' => 'required',
            'admin_category_id' => 'required|exists:admin_categories,id',
