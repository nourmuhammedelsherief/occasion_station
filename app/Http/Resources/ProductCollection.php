        ...
        return [
            ...
            'list' => $this->collection->transform(function ($query ){
                ...
                return [
                    ...
                    'description' => app()->getLocale() == 'ar' ? strip_tags(str_replace('&nbsp;', ' ', $query->description)) : strip_tags(str_replace('&nbsp;', ' ', $query->description_en)),
                    ...
                    'product_requirements' => app()->getLocale() == 'ar' ? strip_tags(str_replace('&nbsp;', ' ', $query->product_requirements)) : strip_tags(str_replace('&nbsp;', ' ', $query->product_requirements_en)),
                    ...
                    'modifiers'   => ProductModifierResource::collection($query->modifiers),
